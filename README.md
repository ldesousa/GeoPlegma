...
fn main() {
    ...
    for (tool, dggs, zone_id) in configs {
        ...
        let generator = dggrs::get(&tool, &dggs).unwrap();

        println!("Global");
        let result = generator.zones_from_bbox(2, false, None).unwrap();
        println!(
            "{:?} \nGenerated {} zones",
            result.zones,
            result.zones.len()
        ...
        let result = generator.zones_from_bbox(2, false, bbox.clone()).unwrap();
        println!(
            "{:?} \nGenerated {} zones",
            result.zones,
            result.zones.len()
        ...
        let result = generator.zones_from_parent(6, zone_id.clone(), false).unwrap();
        println!(
            "{:?} \nGenerated {} zones",
            result.zones,
            result.zones.len()
        ...
        let result = generator.zone_from_id(zone_id.clone(), false).unwrap();
        println!(
            "{:?} \nGenerated {} zones",
            result.zones,
            result.zones.len()
